import{r as g,q as b,j as i,S as y,T as m,c as T,a as j,cb as z,I as U,v as E,Y as L,s as O,cc as R,cd as F,u as B,M as H,b7 as M,B as P,y as v}from"./index-XVuYpdyn.js";function G(){const{selectedSymbol:e}=b(t=>t.terminal),s=g.useRef();return g.useEffect(()=>{if(!s.current)return;s.current.innerHTML="";const t=document.createElement("script");t.src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js",t.type="text/javascript",t.async=!0,t.innerHTML=`
        {
