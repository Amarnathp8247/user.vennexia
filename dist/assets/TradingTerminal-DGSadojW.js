import{r as g,n as b,j as i,S as y,T as m,c as T,a as j,cb as z,I as U,p as E,V as L,s as O,cc as R,cd as F,u as B,M as H,b6 as M,B as P,v}from"./index-ncs-FEhJ.js";function G(){const{selectedSymbol:e}=b(t=>t.terminal),s=g.useRef();return g.useEffect(()=>{if(!s.current)return;s.current.innerHTML="";const t=document.createElement("script");t.src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js",t.type="text/javascript",t.async=!0,t.innerHTML=`
        {
